                ...
                <section className="bg-white min-h-screen flex items-center">
                    <div className="container mx-auto px-4">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 items-stretch min-h-[600px] lg:min-h-[700px]">
                            {/* Left Side - Image */}
                            <div className="relative overflow-hidden rounded-tl-3xl rounded-bl-3xl order-2 lg:order-1">
                                <div
                            ...
                            {/* Right Side - Yellow Content Block */}
                            <div className="bg-yellow-400 relative overflow-hidden rounded-tr-3xl rounded-br-3xl order-1 lg:order-2 flex items-center">
                                ...
                                {/* Decorative geometric elements (bottom-right corner) */}
                                ...
                                {/* Content */}
                                <div className="relative z-10 p-12 lg:p-16 w-full">
                                    <p className="text-sm font-semibold text-black mb-4 uppercase tracking-wide">
                                        Добро пожаловать
                                    </p>
                                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-6 leading-tight">
                                        Грузоперевозки и переезды по всей Грузии.
                                    </h1>
                                    <p className="text-lg text-black/90 mb-10 leading-relaxed max-w-xl">
                                        Подача машины за 30 минут в Тбилиси и Батуми. Гарантируем полную сохранность груза. Работаем по всей стране — от Сарпи до Казбеги.
                                    </p>
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4 mb-12">
                                        <a
                                            ...
                                            className="inline-flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-700 text-white font-bold text-base px-8 py-4 rounded-lg transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
                                        >
                                        ...
                                        <a
                                            href="#services"
                                            className="inline-flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-black font-bold text-base px-8 py-4 rounded-lg transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
                                        >
                                            Наши услуги
                                        </a>
                                    </div>
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                <div className="flex-none w-[85%] md:w-[450px] bg-white border-2 border-gray-200 rounded-2xl overflow-hidden hover:border-yellow-400 hover:shadow-xl transition-all group snap-start">
                                    {/* Image */}
                                ...
                                <div className="flex-none w-[85%] md:w-[450px] bg-yellow-400 border-2 border-yellow-500 rounded-2xl overflow-hidden hover:shadow-2xl transition-all group relative snap-start">
                ...
                <section className="py-20 bg-gradient-to-br from-blue-50 via-sky-50 to-blue-100">
                    <div className="container mx-auto px-4">
                        ...
                        <div className="relative">
                            ...
                            >
                                {/* Минивэн */}
                                <div className="flex-none w-[85%] md:w-[400px] snap-start text-center">
