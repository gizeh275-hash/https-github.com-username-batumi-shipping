...
export const metadata: Metadata = {
    title: 'Грузоперевозки Рустави | Переезды, Грузчики, Транспорт',
    description: 'Профессиональные грузоперевозки и переезды в Рустави. Квартирные и офисные переезды, услуги грузчиков.',
    keywords: 'грузоперевозки Рустави, переезд Рустави, грузчики Рустави, транспорт Рустави',
    openGraph: {
        title: 'Грузоперевозки Рустави - Переезды под ключ',
        description: 'Надежные грузоперевозки и переезды в Рустави',
    },
};
    ...
    return (
        <>
            ...
            <main className="bg-gradient-to-br from-yellow-50 to-white">
                <Hero
                    title="Грузоперевозки в Рустави"
                    subtitle="Профессиональные переезды, грузчики и транспортные услуги в Рустави"
                ...
                {/* About Rustavi Services */}
                <section className="container mx-auto px-4 py-10 md:py-20">
                    <div className="glass-strong p-6 md:p-10 rounded-2xl max-w-4xl mx-auto">
                        <h2 className="text-2xl md:text-3xl font-bold mb-6">Грузоперевозки в Рустави</h2>
                        <p className="text-gray-300 text-base md:text-lg leading-relaxed mb-4">
                            Предоставляем полный спектр услуг по грузоперевозкам в Рустави.
                            Промышленный город недалеко от Тбилиси (всего 25 км) - популярен для офисных переездов и логистики.
                        </p>
                ...
                <section className="container mx-auto px-4 py-20">
                    <h2 className="text-4xl md:text-5xl font-bold text-center mb-16">
                        <span className="gradient-text">Услуги в Рустави</span>
                    </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <Link href="/service/taxi">
                            <ServiceCard
                                ...
                                description="Доставка грузов из Рустави в Тбилиси и другие города Грузии."
                                delay={0.3}
                            />
                        </Link>
                ...
                <section className="container mx-auto px-4 py-20">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                        {['Рустави центр', 'Тбилиси', 'Гардабани', 'Марнеули', 'Болниси', 'Дманиси', 'Цалка', 'Тетрицкаро'].map((area, i) => (
